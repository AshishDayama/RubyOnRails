...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference("Bike.count") do
      post bikes_url, params: { bike: { brand: @bike.brand, model: @bike.model, year: @bike.year } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { brand: @bike.brand, model: @bike.model, year: @bike.year } }
